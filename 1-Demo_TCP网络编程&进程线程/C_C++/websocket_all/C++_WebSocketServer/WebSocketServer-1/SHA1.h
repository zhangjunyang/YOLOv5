...
#ifdef SHA1_UTILITY_FUNCTIONS
	bool ReportHash(TCHAR* tszReport, UINT_8* szOut, REPORT_TYPE rtReportType = REPORT_HEX) const;
#endif

#ifdef SHA1_STL_FUNCTIONS
	bool ReportHashStl(std::basic_string<TCHAR>& strOut, UINT_8* szOut, REPORT_TYPE rtReportType =
		REPORT_HEX) const;
#endif
